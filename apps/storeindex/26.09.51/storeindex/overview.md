...
storeindex maintains a searchable index of news items released for distribution. It reads new
...
the service as text, and ordered keywords, locations, and channels in linked tables for

...
The store must already exist. The
[example configuration](storepack.example.ini) includes all store defaults.
...
| `poll` | `5min` | delay between scans in watch mode, greater than zero |

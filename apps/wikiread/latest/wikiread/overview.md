...
- bounded retry for transient MediaWiki failures
- concise per-file logging with revision IDs

## local data contract

- each `[pages]` key creates one direct output directory
...
- the reader must retain revision history or previous generations

...
The database must contain transmission times, services, channels, keywords, locations,
the source document fields `src_id` and `src_rev`, `headline`, `dispatch_at`,
...
Draft inputs and the sent filter also pause refresh. Returning to the window

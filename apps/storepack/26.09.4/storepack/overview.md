...
Filenames must start with nonnegative integer Unix seconds. The leading ASCII
digits form the timestamp, ending at the first non-digit or the end of the
name. For example, `1789306733_001.leni.json` and `1789306733.001.leni.json`
both use epoch time `1789306733`. The remaining suffix is arbitrary and may
be empty. It is not a fractional part of the timestamp. Names remain unchanged.

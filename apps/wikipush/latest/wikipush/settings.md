...
- relative input and log paths: based on the configuration file directory
...
directly inside those directories are selected. Other extensions and nested
directories are ignored. Symbolic links and junctions at the selected root,
group, or file are rejected. The tool does not modify input files.

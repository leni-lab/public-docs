...
The start page lists apps directly, showing their titles and descriptions.
Apps without `group` appear first, followed by named group headings. Groups
combine apps from all manifests and profiles. Selecting an app opens its

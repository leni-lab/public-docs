...
CREATE TABLE IF NOT EXISTS item (
	...
	timestamp		INTEGER		NOT NULL 			-- epoch time from filename (*)
								CHECK (timestamp >= 0),
	...
	UNIQUE (source, timestamp, suffix)			-- news item identity (*)
);

--------------------------------------------------------------------------------
--	application-specific indexes, extend as needed
--	store timestamps support chronological queries and rebuild cutoffs
